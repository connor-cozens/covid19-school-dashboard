...
if (needs_refresh | is.na(needs_refresh)) {
  ...
  for (i in 0:nrow(covid19_schools_active) - 1){
    covid19_schools_active_with_demographics$confirmed_staff_cases[i] = as.integer(covid19_schools_active$confirmed_staff_cases[i])
  }
  ...
  for (i in 0:nrow(covid19_schools_active) - 1){
    covid19_schools_active_with_demographics$confirmed_unidentified_cases[i] = as.integer(covid19_schools_active$confirmed_unspecified_cases[i])
  }
  ...
  for (i in 0:nrow(covid19_schools_active) - 1){
    covid19_schools_active_with_demographics$total_confirmed_cases[i] = as.integer(covid19_schools_active$total_confirmed_cases[i])
  }
