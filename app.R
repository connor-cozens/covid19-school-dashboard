...
ui <- bootstrapPage(
    ...
    navbarPage(theme = shinytheme('united'), 
               ...
               ('Media',
                   ...
                   br(),
                   h4('October 8 2021'),
                   p(a('Western Homecoming Panel'), href='https://www.edu.uwo.ca/news-events/2021/education-recovery-from-covid.html', target = '_blank'),
                   br(),
                   h4('September 19 2021'),
                   p(a('What London Can Be Podcast - Episode 11: Dr. Prachi Srivastava'), href='https://www.lcf.on.ca/whatlondoncanbe/2021/9/7/episode-11-dr-prachi-srivastava', target = '_blank'),
                   br(),
                   h4('August 4 2021'),
                   p(a('Toronto Star - It\'s back to class for students at a handful of schools across the GTA this week'), href='https://www.thestar.com/news/gta/2021/08/04/its-back-to-class-for-students-at-a-handful-of-schools-across-the-gta-this-week.html', target = '_blank'),
                   br(),
                   h4('August 3 2021'),
                   p(a('Western News - School opening is everyone\'s responsibility, says global expert'), href='https://news.westernu.ca/2021/08/school-opening-is-everyones-responsibility-says-global-expert/', target = '_blank'),
                   br(),
                   h4('July 21 2021'),
                   p(a('640 The Morning Show with Greg Brady - Science Table Releases Recommendations for Reopening Schools in Ontario'), href='https://omny.fm/shows/am640-the-morning-show/science-table-releases-recommendations-for-reopeni', target = '_blank'),
                   p(a('Let\'s Talk London with Jess Brady - Return to in-person lessons essential to student wellbeing: Ontario COVID-19 Science Advisory Table'), href='https://omny.fm/shows/let-s-talk-london/return-to-in-person-lessons-essential-to-student-w', target = '_blank'),
                   br(),
                   h4('July 20 2021'),
                   p(a('The London Free Press - London academic: We can\'t let COVID shut down Ontario schools again'), href='https://lfpress.com/news/local-news/london-academic-we-cant-let-covid-shut-down-ontario-schools-again', target = '_blank'),
                   br(),
                   h4('July 19 2021'),
                   p(a('What She Said! with Candace Sampson - Let That Shit Go, Lady Luck, Education Disruption and Unforked (28:40)'), href='https://soundcloud.com/whatshesaidtalk/let-that-shit-go-lady-luck-education-disruption-and-unforked', target = '_blank'),
                   br(),
                   h4('July 15 2021'),
                   p(a('980 CFPL with Mike Stubbs - Ontario needs a \'real education recovery plan\' to avoid the harms of long-term school closures imposed due to the COVID-19 pandemic'), href='https://omny.fm/shows/london-live-with-mike-stubbs/ontario-needs-a-real-education-recovery-plan-to-av', target = '_blank'),
                   br(),
                   h4('June 28 2021'),
                   p(a('TVO, The Agenda - Ontario’s Education Disruption'), href='https://www.tvo.org/video/ontarios-education-disruption', target = '_blank'),
                   br(),
                   h4('June 27 2021'),
                   p(a('Toronto Star \'How will we catch up?\' With the learning loss by Ontario students this year, what can be done in September to get them back on track'), href='https://www.thestar.com/news/gta/2021/06/27/how-will-we-catch-up-with-the-learning-loss-by-ontario-students-this-year-what-can-be-done-in-september-to-get-them-back-on-track.html', target = '_blank'),
                   br(),
                   h4('June 9 2021'),
                   p(a('CBC Ontario Morning - Wednesday June 9, Part 3'), href='https://www.cbc.ca/player/play/1906968643507', target = '_blank'),
                   br(),
                   h4('June 8 2021'),
                   p(a('CUGH Webinar: Education Continuity, School Operations and the Covid-19 Pandemic: Lessons from the US and Canada'), href='https://www.cugh.org/resources/webinars/webinars-from-2021/education-continuity-sch[…]e-covid-19-pandemic-lessons-from-the-united-states-and-canada/', target = '_blank'),
                   p(a('CTV News - Ottawa parents worry about long-term impacts of school closures amid new analysis on the subject'), href='https://ottawa.ctvnews.ca/ottawa-parents-worry-about-long-term-impacts-of-school-closures-amid-new-analysis-on-the-subject-1.5461894', target = '_blank'),
                   p(a('Ottawa Citizen - Ontario leads the country in COVID-19 school closures — and kids have paid a price, study finds'), href='https://ottawacitizen.com/news/local-news/study', target = '_blank'),
                   br(),
                   h4('June 7 2021'),
                   p(a('London Free Press - \'A real loss\': Local expert urges plan to address students\' learning gaps'), href='https://lfpress.com/news/local-news/this-is-a-real-loss-plan-needed-to-address-students-learning-gaps-expert', target = '_blank'),
                   p(a('The Globe and Mail - Children in Manitoba First Nations community to repeat school year disrupted by COVID-19'), href='https://www.theglobeandmail.com/canada/article-children-in-manitoba-first-nations-community-to-repeat-school-year/', target = '_blank'),
                   br(),
                   h4('June 6 2021'),
                   p(a('The Conversation - End of topsy-turvy school year: 5 education issues exposed by the COVID-19 pandemic'), href='https://theconversation.com/end-of-topsy-turvy-school-year-5-education-issues-exposed-by-the-covid-19-pandemic-161145', target = '_blank'),
                   br(),
                   h4('June 5 2021'),
                   p(a('CFRA Live - With in-person learning in Ontario out of the question until September, how do we address the current learning gaps before the new school year begins?'), href='https://omny.fm/shows/580-cfra/cfra-live-with-in-person-learning-in-ontario-out-o', target = '_blank'),
                   br(),
                   h4('June 4 2021'),
                   p(a('TVO - Ontario is taking \'unnecessary risks\' with our kids\' education'), href='https://www.tvo.org/article/ontario-is-taking-unnecessary-risks-with-our-kids-education', target = '_blank'),
                   p(a('CTV News - What Happens When Kids Go Back To School?'), href='https://ottawa.ctvnews.ca/video?clipId=2215910', target = '_blank'),
                   p(a('Toronto Star - \'Nope, it’s not worth it anymore.\' Attendance sliding at Ontario\'s virtual schools as parents and kids burned out'), href='https://www.thestar.com/news/gta/2021/06/04/nope-its-not-worth-it-anymore-attendance[…]-ontarios-virtual-schools-as-parents-and-kids-burned-out.html', target = '_blank'),
                   p(a('Maclean\'s - The shadow pandemic: How a year of disrupted education could seriously impact Canadian children'), href='https://www.macleans.ca/longforms/covid-19-pandemic-disrupted-schooling-impact/', target = '_blank'),
                   br(),
                   h4('June 2 2021'),
                   p(a('Let\'s Talk London with Jess Brady - Ontario schools to remain closed to in-person learning for rest of academic year'), href='https://omny.fm/shows/let-s-talk-london/ontario-schools-to-remain-closed-to-in-person-lear', target = '_blank'),
                   br(),
                   h4('3 May 2021'),
