    ...
    navbarPage(theme = shinytheme('united'), 
               ...
               tabPanel('About This Site',
                        ...
                        div(
                            ...
                            p('The date shown in the Daily/Weekly Summary pane on the Mapper tab reports the last day on which official data were released by the Ontario Ministry of Education. Currently, this is 27 April 2021.'),
