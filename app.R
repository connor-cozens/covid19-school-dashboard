...
ui <- bootstrapPage(
    ...
    navbarPage(theme = shinytheme('united'), 
               ...
               tabPanel('About This Site',
                        ...
                        br(),
                        h3('CONTEXT'),
                        p('The situation for students and schools is rapidly evolving in Ontario. The following provides a brief policy context. This covers the period from September 2020 – February 2021.'),
                        ...
                        p('Northern PHUs that were permitted to return to in-person learning on January 11, 2021 would continue in-person learning unless otherwise directed by local PHUs. '),
