...
ui <- bootstrapPage(
    ...
    navbarPage(theme = shinytheme('united'), 
               ...
               tabPanel('About This Site',
                        ...
                        p('The date shown in the Daily/Weekly Summary pane on the Mapper tab reports the last day on which official data were released by the Ontario Ministry of Education.'),
               ...
               ('Media',
                    ...
                    h4('May 3rd, 2021'),
                    a('UWO COVID Next Campaign', href='https://uwo.ca/research/excellence/covidnext/#view/2a'),
                    h4('December 29, 2020'),
               ...
               tabPanel('Our Team',
                        ...
                        p(a(href = 'https://twitter.com/br00t4c', target = "_blank", tags$img(src = 'twitter_logo.png', height = '32', width = '32'))),
                        br(),
                        h4('Connor Cozens'),
                        p(em('Developer')),
