...
ui <- bootstrapPage(
    ...
    navbarPage(theme = shinytheme('united'), 
               ...
               tabPanel('About This Site',
                        ...
                        p('This will help to increase transparency and understanding of the education scenario as it evolves. It will help school communities (eg., parents, students, teachers and staff, leaders and administrators), community members and neighbours, education and health professionals, officials, researchers, media, and the general public.'),
                        br(),
                        ...
                        br(),
                        p('The date shown in the Daily/Weekly Summary box on the Mapper tab reports the last day on which official data were released by the Ontario Ministry of Education.'),
                        ...
                        br(),
                        h4('2020-21 School Year'),
                        p('Phased reopening of publicly funded schools in the province began on 8 September 2020 and continued until 21 September 2020, by which time all schools should have opened. This followed a period of province-wide and localised school closures. Schools have been operating virtually as of 19 April 2021, with special in-person provisions for special education needs services.'),
                        p('The figure below shows the main Ontario-level school closure and re-opening periods from September 2020 – February 2021.'),
                        img(src='timeline.png', width='100%'),
                        p(tags$i('Figure 1 Ontario-level school closures and reopening policy tracing (March 2020 – April 2021)')),
                        p('Notes. *: School closures: defined here as the suspension of in-school, face-to-face instruction. Public schools only. Special provisions for face-to-face instruction were made for special education needs services. These are not presented here. Only provincial-level decisions are presented. Individual school boards and PHUs may have additionally instituted localised school closures. These are not presented here.'),
                        p(tags$sup("1"), ': All schools in PHUs of Algoma, North Bay Parry Sound, Northwestern, Porcupine, Sudbury, Thunder Bay, Timiskaming. ', tags$sup("2"), ': All schools in PHUs of Grey Bruce, Haliburton, Kawartha, Pine Ridge, Hastings and Prince Edward Counties, Kingston, Frontenac and Lennox & Addington, Leeds, Grenville and Lanark, Peterborough, Renfrew County. ', tags$sup("3"), ': All schools in PHUs of Eastern Ontario, Middlesex-London, Ottawa, Southwestern. ', tags$sup("4"),': All schools in PHUs of: Brant County, Chatham-Kent, Durham, Haldimand-Norfolk, Halton, Hamilton, Huron Perth, Lambton, Niagara, Simcoe-Muskoka, Waterloo, Wellington-Dufferin-Guelph, Windsor-Essex. ', tags$sup("5"),': All schools in PHUs of: Peel, Toronto, York.'),
                        p('Source. Data extracted from official provincial government announcements  and verified on ICES COVID-19 Dashboard.'),
                        p('Cite as: Srivastava, P. (2020). COVID-19 school dashboard (1.0 Nov 2020). [Web application]. http://covid19schooldashboard.com/'),
                        p(tags$br(), tags$sup("i"), 'https://news.ontario.ca/en/release/59790/ontario-announces-provincewide-shutdown-to-stop-spread-of-covid-19-and-save-lives'),
                        p('https://news.ontario.ca/en/statement/60033/over-100000-ontario-students-return-to-class-beginning-next-week'),
                        p('https://news.ontario.ca/en/statement/60154/280000-more-ontario-students-to-return-to-class'),
                        p('https://news.ontario.ca/en/release/60228/enhanced-safety-measures-in-place-as-in-person-learning-resumes-across-ontario'),
                        p('https://news.ontario.ca/en/release/60228/enhanced-safety-measures-in-place-as-in-person-learning-resumes-across-ontario'),
                        p('https://news.ontario.ca/en/release/61106/ontario-moves-schools-to-remote-learning-following-spring-break'),
                        br(),
                        ...
                        p('On 12 April 2021, it was announced that all schools would revert to virtual schooling as of 19 April 2021 , following the re-scheduled April Break of 12-16 April 2021 during which time schools were closed.'),
                        ...
                        tags$ul(
                            ...
                            tags$li(tags$i('Weekly Summary: Summarizes cumulative school-related cases, current schools with cases (and as % of schools in Ontario), and current schools closed (and as % of schools in Ontario) for 7- or 14-day period from last known data reporting date in the Ministry of Education dataset.'))
                        ),
                        br(),
                        # h4('Plots Tab'),
                        ...
                        tags$ul(
                            tags$li('Recent cases (data available as of 1 October 2020) '),
                        ...
                        p('Dr. Prachi Srivastava , Principal Investigator and Project Lead, Western University'),
                        p('Peter J. Taylor, Technical Lead and Lead Developer'),
                        p('Connor Cozens, Developer'),
                        p('Justin Marshall, Developer'),
                        p('We are open to feedback and continuous improvements. Please report any data discrepancies or other suggestions.'),
                        p('Contact: info@covid19schooldashboard.com'),
                        ...
                        p('application]. http://covid19schooldashboard.com/'),
